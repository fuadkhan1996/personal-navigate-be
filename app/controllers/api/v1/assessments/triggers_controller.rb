    ...
    module Assessments
      class TriggersController < ApplicationController
        ...
        def evaluate_triggers
          if Assessment::EvaluatorService.call(assessment:, triggers: assessment.active_questionnaire_triggers)
        ...
        def set_trigger
          @trigger = assessment.active_questionnaire_triggers.find(params[:id])
        end
