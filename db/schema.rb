...
ActiveRecord::Schema[7.1].define(version: 2024_05_20_191131) do
  ...
  create_table "app_submission_group_schedules", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: nil, null: false
    t.datetime "updated_at", precision: nil, null: false
    t.bigint "submission_group_schedule_template_id"
    t.index ["submission_group_schedule_template_id"], name: "submission_schedule_template_id_on_submission_schedules"
  ...
  create_table "nav_actions", force: :cascade do |t|
    ...
    t.index ["nav_action_type_id"], name: "index_nav_actions_on_nav_action_type_id"
    t.index ["title", "dc_company_employee_id"], name: "index_nav_actions_on_title_and_dc_company_employee_id", unique: true
  end
  ...
  add_foreign_key "app_insured_collaborator_sections", "dc_company_employees", column: "account_id"
  ...
  add_foreign_key "app_submission_group_schedules", "app_submission_group_schedule_templates", column: "submission_group_schedule_template_id"
